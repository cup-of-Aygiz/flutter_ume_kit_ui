...
class _ColorSuckerState extends State<ColorSucker> {
  ...
  Future<void> _onPanStart(DragStartDetails dragDetails) async {
  ...
  void _calculatePixel(Offset globalPosition) {
    ...
    Uint32List data = _snapshot!.toUint8List().buffer.asUint32List();
    int pixel32 = _snapshot!.isBoundsSafe(px.toInt(), py.toInt())
        ? data[py.toInt() * _snapshot!.width + px.toInt()]
        : 0;
